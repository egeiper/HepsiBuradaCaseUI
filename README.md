...
3. Create a GitHub secret with the name `AWS_ACCESS_KEY_ID` and `AWS_SECRET_ACCESS_KEY` and set the values of IAM user and put it into gradle.properties file.
